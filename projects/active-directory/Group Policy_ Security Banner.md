...
```text
gpo-login-banner-configured.png
```
...
* Configured interactive logon security settings.
* Forced policy synchronization using gpupdate.
* Verified policy deployment using gpresult.
* Gained experience with enterprise-style Active Directory administration.
